angular.module("ManageBookApp").controller('EntryCtrl', ['$scope', '$routeParams', '$http', '$window', '$location', '$timeout', 'EntryService',
    ...
    function ($scope, $routeParams, $http, $window, $location, $timeout, EntryService,
        ...
        $scope.filterEntries = function (project, user, filteredStartDate, filteredEndDate,
            filterPriorityA, filterPriorityB, filterPriorityC, filterPriorityD, filterPriorityE) {
